...
6. **BU Image 분석** 체크박스를 켠 경우에만 `bu_image_analysis.xlsx`를 추가로 만듭니다. 끄면 1~5단계만 돌아 이전과 동일하게 동작합니다.
...
제품별 BU 히트맵의 색 분포와 weak point 위치를 정리해 `bu_image_analysis.xlsx`로 남깁니다. 시트는 네 장입니다.
